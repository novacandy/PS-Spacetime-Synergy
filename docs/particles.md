...
- fadeOutTime: The amount of seconds that fading out at the end should take (part of the total moontime). Default is 1.
- fadeInTime: The amount of seconds that fading in should take (part of the total moontime). Default is 0.
...
- You can add other features to particles, but you must impliment their effects yoursemn.
...
- You can use Vue.delete(particles, this.id) to make a particle delete itsemn.
